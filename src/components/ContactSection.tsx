          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="reveal">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-card border border-border hover-lift">
              ...
              {/* Upwork Badge */}
              <div className="mt-8 p-6 rounded-2xl bg-gradient-gold shadow-gold">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-primary-foreground font-bold text-lg">Top Rated</div>
                    <div className="text-primary-foreground/80 text-sm">100% Job Success Rate</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="reveal" style={{ transitionDelay: '0.2s' }}>
              <form className="p-8 rounded-2xl bg-gradient-card border border-border">
                ...
                <div className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-gradient-gold rounded-lg font-semibold text-primary-foreground hover-glow transition-all duration-300 flex items-center justify-center gap-2 group"
                  >
                    Send Message
