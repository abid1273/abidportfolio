...
const UpworkSection = () => {
  ...
  return (
    <section id="upwork" ref={sectionRef} className="py-24 bg-background relative bg-diagonal-lines overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <span className="reveal inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#14a800]/10 text-[#14a800] text-sm font-semibold mb-4">
        ...
        <div className="reveal grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[#14a800] to-[#0d7a00] text-white">
